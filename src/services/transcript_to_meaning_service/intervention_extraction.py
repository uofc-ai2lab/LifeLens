...
async def run_nlp(output_path="./data/meaning_files/interventions_extracted.csv"):
    ...
    if extracted_interventions:
        ...
        out_df = out_df[["start", "end","event_type", "event_category",  
        ...
        pd.DataFrame(columns=["start", "end","event_type", "event_category", 
                              "entity_detected", "text"]).to_csv(output_path, index=False)
