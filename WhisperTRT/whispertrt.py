...
async def transcribe_audio(audio_file: str, model_size: str, model_cache_path: str = None):
    ...
    use_whispertrt = model_size in ["tiny.en", "base.en"]
    ...
    print(bcolors.OKGREEN + "Starting transcription..." + bcolors.ENDC)
    ...
    try:
        ...
        if isinstance(result, dict):
            ...
            if len(segments) > 0:
                ...
                if not use_whispertrt:
                    print(bcolors.WARNING + "This should not happen with original Whisper - check model output" + bcolors.ENDC)
        else:
